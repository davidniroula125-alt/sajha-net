...
const packages = await Package.insertMany([
      ...
      { name: 'Platinum', slug: 'platinum', speed: 200, type: 'internet', billingCycle: 'yearly', price: 9500, installationCharge: 0, image: '', badge: 'Recommended', features: ['Unlimited Internet', 'No Deposit Required', 'FREE WiFi Router', 'FREE Drop Wire', 'Fiber Connection', '24/7 Customer Support', 'Professional Installation', 'High-Speed Fiber Network'], includes: { router: true, mesh: false, tv: false, phone: false, ott: [], unlimitedData: true, dropWire: true, fairUsagePolicy: '' }, idealFor: ['Power Users', '4K Streaming', 'Multiple Users'], highlights: ['No Deposit', 'Free Router', 'Premium Speed'], isPopular: false, isRecommended: true, sortOrder: 4, description: 'Platinum package — 200 Mbps fiber internet for power users.', shortDescription: '200 Mbps Fiber Internet', seo: { title: 'Platinum Package — 200 Mbps Internet at Rs. 9,500/year | Sajha Net', description: 'Platinum package with 200 Mbps fiber internet, no deposit required, free router and drop wire included.', keywords: ['platinum package', '200 Mbps internet', 'Rs 9500 yearly', 'Sajha Net Platinum'] } },
      ...
      { name: 'Business Starter', slug: 'business-starter', speed: 100, type: 'business', billingCycle: 'yearly', price: 7500, installationCharge: 0, image: '', badge: '', features: ['100 Mbps Dedicated', 'Fiber Connection', '99.9% Uptime SLA', '24x7 Priority Support', 'Static IP', 'FREE Router', 'FREE Drop Wire'], includes: { router: true, mesh: false, tv: false, phone: false, ott: [], unlimitedData: true, dropWire: true, fairUsagePolicy: '' }, idealFor: ['Small Business', 'Startups'], highlights: ['SLA Guarantee', 'Priority Support', 'Static IP'], isPopular: false, isRecommended: false, sortOrder: 8, description: 'Business Starter package — 100 Mbps dedicated fiber internet.', shortDescription: '100 Mbps Business Internet', seo: { title: 'Business Starter Package — 100 Mbps Dedicated Internet at Rs. 7,500/year | Sajha Net', description: 'Business Starter with 100 Mbps dedicated fiber, SLA guarantee, static IP, and priority support.', keywords: ['business starter', '100 Mbps business', 'Rs 7500 yearly', 'SLA guarantee'] } },
      { name: 'Business Pro', slug: 'business-pro', speed: 300, type: 'business', billingCycle: 'yearly', price: 15000, installationCharge: 0, image: '', badge: '', features: ['300 Mbps Dedicated', 'Fiber Connection', '99.99% Uptime SLA', '24x7 Priority Support', 'Static IP', 'Managed WiFi', 'FREE Router', 'FREE Drop Wire'], includes: { router: true, mesh: true, tv: false, phone: false, ott: [], unlimitedData: true, dropWire: true, fairUsagePolicy: '' }, idealFor: ['Growing Business', 'Offices'], highlights: ['Enterprise SLA', 'Managed WiFi', 'Dedicated Support'], isPopular: false, isRecommended: true, sortOrder: 9, description: 'Business Pro package — 300 Mbps dedicated fiber internet.', shortDescription: '300 Mbps Business Internet', seo: { title: 'Business Pro Package — 300 Mbps Dedicated Internet at Rs. 15,000/year | Sajha Net', description: 'Business Pro with 300 Mbps dedicated fiber, enterprise SLA, static IP, managed WiFi, and 24/7 priority support.', keywords: ['business pro', '300 Mbps business', 'Rs 15000 yearly', 'enterprise SLA'] } }
    ]);
