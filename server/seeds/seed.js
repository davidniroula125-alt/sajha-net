...
const seedData = async () => {
  try {
    ...
    const packages = await Package.insertMany([
      { name: 'Bronze', speed: 80, type: 'internet', price: { monthly: 6500, quarterly: 0, halfYearly: 0, yearly: 6500 }, installationCharge: 0, features: ['80 Mbps Speed', 'Fiber Connection', '99.9% Uptime', '24x7 Support', 'FREE Router + Drop Wire', 'No Deposit Required'], includes: { router: true, unlimitedData: true }, idealFor: ['Browsing', 'Social Media', 'Light Streaming'], highlights: ['No Deposit', 'Free Router', 'Free Drop Wire'], isPopular: false, sortOrder: 1 },
      { name: 'Silver', speed: 100, type: 'internet', price: { monthly: 7500, quarterly: 0, halfYearly: 0, yearly: 7500 }, installationCharge: 0, features: ['100 Mbps Speed', 'Fiber Connection', '99.9% Uptime', '24x7 Support', 'FREE Router + Drop Wire', 'No Deposit Required'], includes: { router: true, unlimitedData: true }, idealFor: ['Family', 'Streaming', 'HD Video'], highlights: ['No Deposit', 'Free Router', 'Fast Speed'], isPopular: true, sortOrder: 2 },
      { name: 'Gold', speed: 150, type: 'internet', price: { monthly: 8500, quarterly: 0, halfYearly: 0, yearly: 8500 }, installationCharge: 0, features: ['150 Mbps Speed', 'Fiber Connection', '99.9% Uptime', '24x7 Support', 'FREE Router + Drop Wire', 'No Deposit Required'], includes: { router: true, unlimitedData: true }, idealFor: ['Multiple Devices', 'HD Streaming', 'Gaming'], highlights: ['No Deposit', 'Free Router', 'High Speed'], isPopular: false, sortOrder: 3 },
      { name: 'Platinum', speed: 200, type: 'internet', price: { monthly: 9500, quarterly: 0, halfYearly: 0, yearly: 9500 }, installationCharge: 0, features: ['200 Mbps Speed', 'Fiber Connection', '99.9% Uptime', '24x7 Support', 'FREE Router + Drop Wire', 'No Deposit Required'], includes: { router: true, unlimitedData: true }, idealFor: ['Power Users', '4K Streaming', 'Multiple Users'], highlights: ['No Deposit', 'Free Router', 'Premium Speed'], isPopular: false, sortOrder: 4 },
      { name: 'Essential', speed: 80, type: 'combo', price: { monthly: 8500, quarterly: 0, halfYearly: 0, yearly: 8500 }, installationCharge: 0, features: ['80 Mbps Internet + IP TV', 'Fiber Connection', '99.9% Uptime', '24x7 Support', 'FREE Router + Drop Wire', 'No Deposit Required'], includes: { router: true, tv: true, unlimitedData: true }, idealFor: ['Entertainment', 'Family', 'TV + Internet'], highlights: ['Internet + IPTV', 'No Deposit', 'Free Router'], isPopular: false, sortOrder: 5 },
      { name: 'Enhanced', speed: 150, type: 'combo', price: { monthly: 9500, quarterly: 0, halfYearly: 0, yearly: 9500 }, installationCharge: 0, features: ['150 Mbps Internet + IP TV', 'Fiber Connection', '99.9% Uptime', '24x7 Support', 'FREE Router + Drop Wire', 'No Deposit Required'], includes: { router: true, tv: true, unlimitedData: true }, idealFor: ['Family Entertainment', 'HD Streaming + TV'], highlights: ['Internet + IPTV', 'No Deposit', 'High Speed'], isPopular: true, sortOrder: 6 },
      { name: 'Premium', speed: 200, type: 'combo', price: { monthly: 10500, quarterly: 0, halfYearly: 0, yearly: 10500 }, installationCharge: 0, features: ['200 Mbps Internet + IP TV', 'Fiber Connection', '99.9% Uptime', '24x7 Support', 'FREE Router + Drop Wire', 'No Deposit Required'], includes: { router: true, tv: true, unlimitedData: true }, idealFor: ['Ultimate Bundle', 'Power Users', '4K + TV'], highlights: ['Internet + IPTV', 'No Deposit', 'Ultimate Speed'], isPopular: false, sortOrder: 7 },
      { name: 'Business Starter', speed: 100, type: 'business', price: { monthly: 7500, quarterly: 0, halfYearly: 0, yearly: 7500 }, installationCharge: 0, features: ['100 Mbps Dedicated', 'Fiber Connection', '99.9% Uptime SLA', '24x7 Priority Support', 'Static IP'], includes: { router: true, unlimitedData: true }, idealFor: ['Small Business', 'Startups'], highlights: ['SLA Guarantee', 'Priority Support', 'Static IP'], isPopular: false, sortOrder: 8 },
      { name: 'Business Pro', speed: 300, type: 'business', price: { monthly: 15000, quarterly: 0, halfYearly: 0, yearly: 15000 }, installationCharge: 0, features: ['300 Mbps Dedicated', 'Fiber Connection', '99.99% Uptime SLA', '24x7 Priority Support', 'Static IP', 'Managed WiFi'], includes: { router: true, mesh: true, unlimitedData: true }, idealFor: ['Growing Business', 'Offices'], highlights: ['Enterprise SLA', 'Managed WiFi', 'Dedicated Support'], isPopular: false, sortOrder: 9 }
    ]);
